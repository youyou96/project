package com.bird.yy.project.manager
...
import com.bird.yy.project.entity.AdResourceBean
...
import com.bird.yy.project.entity.AdTimeBean
import com.bird.yy.project.utils.DateUtil
...
import com.unlimited.stable.earth.databinding.AdViewResultBinding
...
class AdManage {
    ...
    private fun loadNativeAd(
        ...
        val location =
            if (adType == Constant.adNative_h) NativeAdOptions.ADCHOICES_TOP_RIGHT else NativeAdOptions.ADCHOICES_TOP_LEFT
        val adLoader =
            builder
                .withAdListener(
                    object : AdListener() {
...
//            mainActivityBinding.refreshButton.isEnabled = true
    ...
    fun addClickTimeOrShowTime(showNum: Int, clickNum: Int) {
        ...
        if (DateUtil().getTime() == adTimeBean.timeLast) {
